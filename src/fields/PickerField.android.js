...
import {PickerComponent, PickerSectionComponent} from '../lib/PickerComponent';
...
export class PickerFieldOld extends React.Component{
  setValue(value){
    this.refs.fieldComponent.setValue(value)
  }
  render(){
